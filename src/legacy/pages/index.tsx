...
import {
  State,
  disableMainPageAnimation,
  setEffectSettingDrawLineDuration,
  setTutorialSettingSceneDuration,
  resetAllSetting,
  setEffectSettingPlacementEffect,
  setEffectSettingLastPieceEmphasized,
...
const Main = () => {
  ...
  const mainPageAnimation = useSelector<State, boolean>(
    (state) => state.page.main.animation
  );
    ...
    <Page id="main" title="relati">
      <div className="main-control">
        ...
        <Button.Group className={buttonGroupClassName}>
          <IconButton
            ...
            color="crimson"
            title="開始遊玩"
            onClick={toChooseGameModePage}
          />
          <IconButton
            type="help"
            color="royalblue"
            title="如何遊玩"
            onClick={toChooseTutorialModePage}
          />
        </Button.Group>
      </div>
      ...
      <Button.Group className={bottomButtonGroupClassName}>
        <IconButton
          ...
          title="策略"
          color="seagreen"
          onClick={toChoosePuzzleModePage}
        />
